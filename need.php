...
<html>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							...
							<li class="active"><a href="need.php">我有需求</a></li>
		...
		<div id="page">
			...
			<div id="main" class="container">
				    <div style="align:center; width:50em; margin: 0 auto; border-width:3px; border-style:solid; border-color: #e95d3c; border-radius:0.5em; border-bottom-right-radius:1.5em; display:inline-block;">
					    <div id="small_title" style="align:center;border-bottom-right-radius:0.5em;  width: 40%">我&nbsp&nbsp有&nbsp&nbsp需&nbsp&nbsp求</div>
						<?php 
	...
	<!-- Copyright -->
		<div id="copyright" class="container" style="top: 1100px;">
